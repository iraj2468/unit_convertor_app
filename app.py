...
class BookCollection:
    """A Class to manage a collection of books, allowing users to store and organize their reading many books"""
    ...
    def find_book(self):
        ...
        search_text = input("Enter search terms: ").lower()
        found_books = [
            book
            for book in self.book_list
    ...
    def show_reading_progress(self):
        """Calculate and display the statistics about your reading progress."""
    ...
    def start_application(self):
        ...
        while True:
            ...
            if user_choice == "1":
                ...
                self.save_to_file()
                print("Thank you for using the book collection manager! Best of luck & Goodbye!")
                break
            else:
